...
public class CorrespondenceDaoImpl extends HibernateDaoSupport implements
	...
	try {
	    List<Correspondence> listResults = getHibernateTemplate().find("from Correspondence");
	    return listResults;
	}catch (Exception e) {
	...
	List<Correspondence> correspondenceList = getHibernateTemplate().findByCriteria(dc);
